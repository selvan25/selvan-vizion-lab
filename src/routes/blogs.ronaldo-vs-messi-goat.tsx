  ...
  return (
    <article className="overflow-x-hidden" style={{ color: C.text }}>
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl py-10 sm:py-14">
        ...
        {/* SECTION 9 */}
        <SectionHeading kicker="Section 9">Carrying the Blame, Carrying the Team</SectionHeading>
        <Reveal>
        ...
        <Reveal>
          ...
          <P>But if greatness is conquering different leagues, adapting to different systems, reinventing yourself over two decades, carrying expectations across multiple countries, and becoming the most complete goalscorer football has ever seen — then Ronaldo stands alone. Messi is proof of what talent can do. Ronaldo is proof of what obsession can do.</P>
          <P>Because here's the part the spreadsheet can never capture: Ronaldo is football's <strong>complete player</strong>. He scores with his <strong>left foot</strong> and his <strong>right</strong>, with powerfull <strong>headers</strong>, stunning <strong>free kicks</strong>, jaw-dropping <strong>bicycle kicks</strong>, and <strong>acrobatic</strong> volleys. He has blistering <strong>speed</strong>, thunderous <strong>long shots</strong>, slick <strong>dribbling</strong>, ice-cold <strong>clutch</strong> instincts, and the calm of a <strong>penalty master</strong> under the whole world's gaze. He <strong>creates</strong> as well as he finishes — sharp <strong>playmaking</strong> and <strong>pinpoint passing</strong> — all wrapped in an <strong>athletic engine</strong> that refuses to age. There is no part of the game he hasn't mastered.</P>
        </Reveal>
        <Reveal><CompletePlayer /></Reveal>
        <Reveal>
          <P>And the most dangerous thing about Ronaldo was never his talent. It was the <strong>certainty</strong> — the belief he created in everyone's mind. For 90 minutes, defenders could do everything right. The team could play the perfect game, the crowd could be against him but, none of it seemed to matter. Because Ronaldo had a rare ability to change the outcome of a match in a single moment. One cross. One header. One chance. One shot. That was all he needed to turn their best performance into a defeat. They didn't wonder <em>if</em> he would score. They wondered <em>when</em>.</P>
