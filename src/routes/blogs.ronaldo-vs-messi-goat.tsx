...
/* ---------------- CREATIVE COVER (SVG duel) ---------------- */
function DuelCover() {
  return (
    <svg viewBox="0 0 1280 720" className="h-full w-full" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Ronaldo versus Messi — the GOAT debate">
      <defs>
        <linearGradient id="cr7Side" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#1a0608" />
          <stop offset="55%" stopColor="#7a1020" />
          <stop offset="100%" stopColor="#E63946" />
        </linearGradient>
        <linearGradient id="messiSide" x1="1" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#05111f" />
          <stop offset="55%" stopColor="#1e4d7a" />
      ...
      {/* Split background */}
      <polygon points="0,0 700,0 560,720 0,720" fill="url(#cr7Side)" />
      <polygon points="700,0 1280,0 1280,720 560,720" fill="url(#messiSide)" />
      <rect width="1280" height="720" fill="url(#glow)" />

      {/* Diagonal seam */}
      <polygon points="700,0 720,0 580,720 560,720" fill="#ffffff" opacity="0.08" />

      {/* Abstract player silhouettes (stylized, non-photographic) */}
      {/* CR7 figure — mid celebration, arms wide */}
      <g opacity="0.92" filter="url(#soft)" transform="translate(250,250)">
        <circle cx="0" cy="-70" r="34" fill="#0c0306" />
        <path d="M -55 -20 Q 0 -55 55 -20 L 42 30 Q 0 12 -42 30 Z" fill="#0c0306" />
        <path d="M -55 -20 L -120 -50 M 55 -20 L 120 -50" stroke="#0c0306" strokeWidth="22" strokeLinecap="round" />
        <path d="M -28 30 L -38 150 M 28 30 L 38 150" stroke="#0c0306" strokeWidth="26" strokeLinecap="round" />
      </g>

      {/* Messi figure — dribbling lean */}
      <g opacity="0.92" filter="url(#soft)" transform="translate(1010,255)">
        <circle cx="0" cy="-70" r="32" fill="#04101c" />
        <path d="M -50 -18 Q 0 -50 50 -18 L 40 28 Q 0 12 -40 28 Z" fill="#04101c" />
        <path d="M -50 -18 L -108 10 M 50 -18 L 96 -56" stroke="#04101c" strokeWidth="20" strokeLinecap="round" />
        <path d="M -26 28 L -54 140 M 26 28 L 20 150" stroke="#04101c" strokeWidth="24" strokeLinecap="round" />
        <circle cx="-70" cy="170" r="16" fill="#04101c" />
      </g>

      {/* Numbers */}
      <text x="250" y="470" textAnchor="middle" fontFamily="'Space Grotesk', sans-serif" fontWeight="700" fontSize="120" fill="#ffffff" opacity="0.95">7</text>
      <text x="1010" y="470" textAnchor="middle" fontFamily="'Space Grotesk', sans-serif" fontWeight="700" fontSize="120" fill="#ffffff" opacity="0.95">10</text>

      {/* VS badge */}
      <circle cx="640" cy="360" r="64" fill="#0b0b0f" stroke="#F4A026" strokeWidth="3" />
      <text x="640" y="378" textAnchor="middle" fontFamily="'Space Grotesk', sans-serif" fontWeight="700" fontSize="46" fill="#F4A026">VS</text>

      {/* Bottom label */}
      <text x="250" y="560" textAnchor="middle" fontFamily="'Space Grotesk', sans-serif" fontWeight="600" fontSize="34" fill="#ffffff" letterSpacing="3" opacity="0.9">THE NOMAD</text>
      <text x="1010" y="560" textAnchor="middle" fontFamily="'Space Grotesk', sans-serif" fontWeight="600" fontSize="34" fill="#ffffff" letterSpacing="3" opacity="0.9">THE NATIVE</text>
    </svg>
  );
}
